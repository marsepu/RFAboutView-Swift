...
open class RFAboutViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,MFMailComposeViewControllerDelegate,SFSafariViewControllerDelegate {
    ...
    */
    public init(appName: String? = Bundle.main.object(forInfoDictionaryKey: "CFBundleName") as? String, appVersion: String? = Bundle.main.object(forInfoDictionaryKey: "CFBundleShortVersionString") as? String, appBuild: String? = Bundle.main.object(forInfoDictionaryKey: "CFBundleVersion") as? String, copyrightHolderName: String? = "Developer", contactEmail: String? = nil, contactEmailTitle: String? = nil, websiteURL: URL? = nil, websiteURLTitle: String? = nil, pubYear: String? = String(describing: (Calendar.current as NSCalendar).components(NSCalendar.Unit.year, from: Date()).year)) {
        ...
        self.pubYear = pubYear ?? String(describing: (Calendar.current as NSCalendar).components(NSCalendar.Unit.year, from: Date()).year)
    }
    ...
    fileprivate func createAndAddCopyrightLabel(headerView: UIView) -> UILabel {
        ...
        copyrightInfo.backgroundColor = .clear
    ...
    fileprivate func createAndAddTableHeaderLabel(scrollViewContainer: UIView) -> UILabel {
        ...
        tableHeaderLabel.backgroundColor = .clear
    ...
    fileprivate func setConstraints(mainScrollView: UIScrollView, scrollViewContainer: UIView, headerView: UIView, appNameLabel: UILabel, copyrightInfo: UILabel, eMailButton: UIButton, websiteButton: UIButton, tableHeaderLabel: UILabel) {
        ...
        */
        ...
        metrics = ["padding":padding as AnyObject,
            "doublePadding": padding * CGFloat(2) as AnyObject,
            "tableViewHeight":tableViewHeight as AnyObject,
            "additionalButtonsTableHeight":additionalButtonsTableHeight as AnyObject]
    ...
    */
    ...
    fileprivate func reformatAcknowledgementsDictionary(_ originalDict: NSDictionary) -> [[String: String]] {
        ...
        if let array: NSArray = originalDict.object(forKey: "PreferenceSpecifiers") as? NSArray {
          let mutable: NSMutableArray = array.mutableCopy() as! NSMutableArray
          mutable.removeObject(at: 0)
          mutable.removeLastObject()
          for item: Any in mutable {
            if let innerDict: NSDictionary = item as? NSDictionary {
              if let tempTitle = innerDict.object(forKey: "Title") as! String!, let tempContent = innerDict.object(forKey: "FooterText") as! String! {
